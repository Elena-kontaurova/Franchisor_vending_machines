...
def open_ychet_1(_):
    ...
    text = tk.Label(hh, text='Учет аппаратов для напитков', background='#c4cacf',
                    font=('', 17))
...
def open_ychet_2(_):
    ...
    text = tk.Label(hh, text='Учет аппаратов для сладостей', background='#c4cacf',
                    font=('', 17))
    text.place(x=70, y=30)
...
def open_glavna():
    ...
    def open_pod_menu_ychet(_):
        ...
        tt = tk.Label(ststs, text='Аппараты для напитков', background='#0b1217',
                      fg='white', font=('', 10))
        tt.place(x=30, y=10)
        tt.bind('<Button-1>', open_ychet_1)
        tg = tk.Label(ststs, text='Аппараты для сладостей', background='#0b1217',
                      fg='white', font=('', 10))
        tg.place(x=30, y=30)
